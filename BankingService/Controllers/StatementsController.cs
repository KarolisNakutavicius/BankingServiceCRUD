...
namespace BankingService.Controllers
{
    ...
    public class StatementsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Statement>> CreateStatement(int accountID, Statement newStatement)
        {
            ...
            return CreatedAtAction("GetStatement", new { accountID = accountID,  statementID = newStatement.StatementID }, newStatement);
        }
        ...
        [HttpPut("{statementID}")]
        public async Task<IActionResult> PutStatement(int accountID, int statementID, EditStatementDto updatedStatement)
        {
